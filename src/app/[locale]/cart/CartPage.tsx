      ...
      {isEmpty ? (
        <div className="max-w-6xl mx-auto py-16 px-4">
          ...
          <Link
            ...
            aria-label="ürün sayfasına geri dön"
          >
        ...
        <div className="max-w-6xl mx-auto py-8 px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-3 flex items-center gap-2">
                        <button
                          onClick={() => {
                            if (it.quantity > 1) {
                              dispatch(decreaseQty(it.id));
                            } else {
                              handleRemoveClick(it.id);
                            }
                          }}
            ...
            <aside className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <button className="w-full py-3 rounded-lg bg-sky-700 text-white font-medium">
                {t("cart.checkout")}
              </button>
